...
<form action="updateSerie" method="post">
 ...
 <input type="text" name="idSerie" value="${serie.idSerie}"
...
class="form-control"/>
 ...
 <div class="form-group">
 <label class="control-label">Prix Serie :</label>
 <input type="text" name="prixSerie" value="${serie.prixSerie}"
class="form-control"/>
 </div> 
 <div class="form-group">
 <label class="control-label"> Date creation :</label>
 <fmt:formatDate pattern="yyyy-MM-dd" value="${serie.dateCreation}" var="formatDate" />
