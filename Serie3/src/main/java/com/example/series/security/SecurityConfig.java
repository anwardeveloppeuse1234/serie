package com.example.series.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
 ...
 http.authorizeRequests().antMatchers("/saveSerie").hasAnyRole("ADMIN","AGENT");
 http.authorizeRequests().antMatchers("/ListeSeries")
 .hasAnyRole("ADMIN","AGENT","USER");
 
 http.authorizeRequests()
 .antMatchers("/supprimerSerie","/modifierSerie","/updateSerie")
 .hasAnyRole("ADMIN");
